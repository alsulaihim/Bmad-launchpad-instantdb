      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        {generating ? (
          <div className="text-center py-12">
            ...
            <h2 className="text-lg font-semibold mb-2">Generating your PRD...</h2>
          ...
          <>
            ...
            {/* Vibe Coding Prompt */}
            <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border-2 border-purple-500/20 rounded-lg p-8">
              <div className="flex items-center gap-3 mb-4">
                <Sparkles className="h-6 w-6 text-purple-500" />
                <h2 className="text-2xl font-bold">Ready to Start Vibe Coding?</h2>
              </div>
              ...
              <div className="bg-background/50 border border-border rounded-lg p-6 mb-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium">Vibe Coding Initial Prompt</span>
                  </div>
